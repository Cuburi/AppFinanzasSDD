...
| Current canonical source commit/version | Working-tree roadmap refresh after RM-026 publication via PR #190 (`a5cd000`) and cleanup PR #192 (`89aee71`); this refresh is pending normal Git review and publication. |
