...
2. Read the affected page and existing primitive API before editing.
3. Write behavior/accessibility tests first when changing rendered UI.
4. Implement the smallest token-backed change that satisfies the scenario.
5. Run the relevant client tests; run the full client test command for final visual-system slices.
